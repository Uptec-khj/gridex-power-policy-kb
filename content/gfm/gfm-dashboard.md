...
| 한국 공식 문서 노트 | 7 | KSGA 현행 표준, 정부 발표, 한전 연계기술기준 개정안, KPX 시장규칙·세부운영규정·모델 제출안, KTL 시험서비스 |
| 한국 추적 항목 | 2 | KSGA 개정 준비, 한전 공청회·기준 수립 이력 |
| 공식 전문·페이지 확인 | 23 | 열람 가능과 재배포 가능은 별개 |
...
| 트랙 | 현재 확인 상태 | 다음 확인점 |
|---|---|---|
| KSGA 단체표준 | `KSGA-025-18-1:2023 Ed1` 확정·공개. 개발현황은 로그인 제한, 작업반 공개 게시물 없음 | 개정안의 공식 공개회람·심의 단계·판본 |
| 한전 계통연계기준 | 2026-05 사전예고 개정안 3.28, 11.1~11.8 확인. 이용규정 제11·14·35·63조와 별표 9·10은 자료제출 근거 | 제5차 개정 확정본, 부록 1 시험절차서, 인용 이용규정 현행 전문 |
...
- [한국 GFM 근거공백 점검](00_Home/한국_GFM_근거공백_점검_2026_09_11.md)
