...
| 한국 공식 문서 노트 | 4 | KSGA 현행 표준, 정부 발표, KPX 시행 규칙, KTL 시험서비스 안내 |
| 한국 추적 항목 | 2 | KSGA 개정 준비, 한전 공청회·기준 수립 이력 |
| 공식 전문·페이지 확인 | 20 | 열람 가능과 재배포 가능은 별개 |
...
| KPX 시장운영규칙 | 2026-04-29 시행본의 GFM 정의·성능·검증·변경관리 조항 확인 | 계통평가세부운영규정의 시험 수치·판정·서식 |
