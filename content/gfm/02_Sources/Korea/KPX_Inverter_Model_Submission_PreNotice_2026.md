...
review_status: 본문·첨부2 개정안·한전 개정안 인용 관계 검토
...
공지에서 연결한 한전 근거는 `송·배전용전기설비이용규정 제35조 제3항`과 `송전계통연계 기술기준 12. 설비특성자료`다. 별도로 확인한 한전 [제5차 연계기술기준 개정안](KEPCO_Renewable_Transmission_Interconnection_GFM_Draft_2026_05.md)은 개정 후 13.1에서 이용규정 제11·14·35·63조와 별표 9·10을 자료제출 근거로 인용하고, GFM 성능은 11.1~11.8에 둔다. 이용규정 인용과 GFM 성능조항을 구분한다.
