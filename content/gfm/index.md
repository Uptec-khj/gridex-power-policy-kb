...
| 한국 공식 문서 노트 | 2 | KSGA 현행 단체표준, 정부 GFM BESS 성능요건 발표 |
| 한국 추적 항목 | 2 | KSGA 개정 준비, 한전 공청회·기준 수립 이력 |
| 공식 전문 공개 확인 | 18 | 열람 가능과 재배포 가능은 별개 |
...
| 한전 계통연계기준 | 의견수렴을 거친 GFM BESS 성능요건 마련이 정부 보도자료로 확인됨 | 송·배전용 전기설비 이용규정의 정확한 개정 조항·시행본 |
| KPX 시장운영규칙 | GFM 운영기준 준수 대상임이 정부 발표에 명시됨 | 전력시장운영규칙 개정 조항·별표·시행일 원문 대조 |
| 제품 인증 | GFM 전용 국내 제품인증 스킴은 이번 공개조사에서 미확인 | 인증기관 규칙·KOLAS 인정범위·실제 증서 원장 |
