...
공식 자료 **30건**을 연결했습니다. 전력수급·송변전계획 전문, 수요전망, 수립위원회·환경평가·공청회·토론회 자료와 기관 사보 해설을 포함합니다. 탐색 허브, 동일 문서의 PDF/HWP 형식 차이는 별도 문서로 세지 않습니다. 원본 첨부 28개를 SHA-256으로 보존했습니다.

조사 기준일은 **2026-09-09**입니다. 제12차 제7차 토론회 공지(9월 18일 개최 예정)까지 확인했고, 제10·11차 장기 송변전설비계획 전문을 확보했습니다. 일부 산업부 첨부와 제12차 실제 발표자료·수요전망 원표는 추가 수집 대상입니다. 조사 경로에서 제12차 확정본은 확보하지 못했으며, 전체 공개자료의 완전한 목록을 뜻하지 않습니다.
