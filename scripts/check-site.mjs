...
for (const m of publicDocuments) assert.equal(content[m.slug].published_date, m.published_date)
const dates = trie.findNode(['documents']).children.map(n => Date.parse(n.data.published_date) || 0)
